...
// --- ОТДАЧА HTML СТРАНИЦ ---
// =================================================================
// Redirect bare URLs to their index.html equivalents
app.get('/dashboard', (req, res) => res.redirect('/dashboard/'));
app.get('/docs', (req, res) => res.redirect('/docs/'));
app.get('/manage', (req, res) => res.redirect('/manage/'));
app.get('/news', (req, res) => res.redirect('/news/'));
app.get('/privacy', (req, res) => res.redirect('/privacy/'));
app.get('/profile', (req, res) => res.redirect('/profiel/')); // Corrected typo from `profiel` to `profile` if intended
...
app.use('/profiel', express.static(path.join(__dirname, 'public', 'profiel')));
